...
const handleOpen=()=>{
  ...
  return (
    ...
    <button onClick={handleOpen} className='font-semibold hover:text-accent-500 flex items-center'>{t('navbar.meetings')} 
    ...
    <DropDown isOpen={isOpen} setIsOpen={setIsOpen}> 
        <div className='hidden lg:flex flex-col  gap-2 p-3 rounded-lg bg-background-50 border border-background-200   ' >
          <div className='flex  gap-2 items-center justify-center '>
            ...
            <button onClick={handleCreateRoom} className='bg-accent-500 hover:bg-accent-400 text-white px-4 py-2 rounded-md duration-200 flex items-center gap-1'>{t('navbar.createMeeting')}</button>
          </div>
          ...
          <div className='h-[1px] bg-background-200 w-full'></div>
            ...
            <button onClick={handleJoinRoom} className='bg-accent-500 hover:bg-accent-400 text-white px-4 py-2 rounded-md duration-200 w-full'>{t('navbar.joinMeeting')}</button>

            </div>
          <div className='h-[1px] bg-background-200 w-full'></div>
 
            <Link to='/manage-rooms' className='text-blue-600 text-center' onClick={handleOpen}>{t('navbar.manageMeeting')}</Link>
        </div>
